...
const ko = {
  ...
  vs: {
    ...
    topics: {
      general: "전체적인 운영 팁",
      whiff_punish: "윕퍼 노릴 만한 동작",
      block_punish: "가드 후 확정 딜캐",
      pressure_gap: "압박 중 끼어드는 지점",
      other: "기타",
    },
    empty: "아직 공략이 없습니다.",
    none: "조건에 맞는 공략이 없습니다.",
    noImage: "이미지 없음",
  },
  ...
  setup: {
    ...
    delay: "딜레이",
    noSlot: "없음",
    result: { hit: "히트", guard: "가드", whiff: "헛침", other: "기타" },
    linked: "셋업",
  },
...
const en: Dictionary = {
  ...
  overview: {
    ...
    pros: "Strengths",
    cons: "Weaknesses",
    modern: "Classic / Modern differences",
  ...
  vs: {
    ...
    topics: {
      general: "Game plan",
      whiff_punish: "Whiff punish targets",
      block_punish: "Punishes on block",
      pressure_gap: "Gaps in pressure",
      other: "Other",
    },
    empty: "No guides yet.",
    none: "No guides match these filters.",
    noImage: "No image",
  },
  ...
  setup: {
    ...
    delay: "Delay",
    noSlot: "None",
    result: { hit: "Hit", guard: "Block", whiff: "Whiff", other: "Other" },
    linked: "Setups",
  },
...
const ja: Dictionary = {
  ...
  vs: {
    ...
    topics: {
      general: "全体的な立ち回り",
      whiff_punish: "差し返しを狙える技",
      block_punish: "ガード後の確定反撃",
      pressure_gap: "攻めの割り込みポイント",
      other: "その他",
    },
    empty: "まだ攻略がありません。",
    none: "条件に合う攻略がありません。",
  ...
  setup: {
    ...
    delay: "ディレイ",
    noSlot: "なし",
    result: { hit: "ヒット", guard: "ガード", whiff: "空振り", other: "その他" },
    linked: "セットプレイ",
  },
