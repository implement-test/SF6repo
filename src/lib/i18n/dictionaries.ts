...
const ko = {
  ...
  setup: {
    ...
    situation: "상황",
    guard: "가드",
    guardValues: { all: "전부 가드", none: "가드 안 함", after_first: "첫 타 후 가드", random: "랜덤 가드" },
    wakeup: "기상 시 리버설",
    afterGuard: "가드 후 리버설",
    afterGuardN: "{n}회 가드 후",
    afterHit: "피격 후 리버설",
    playback: { random: "여러 슬롯 랜덤 재생", sequential: "순서대로 재생" },
    noSlot: "없음",
    linked: "셋업",
  },
...
const en: Dictionary = {
  ...
  setup: {
    ...
    situation: "Situation",
    guard: "Guard",
    guardValues: { all: "Guard all", none: "No guard", after_first: "Guard after first hit", random: "Random guard" },
    wakeup: "Wake-up reversal",
    afterGuard: "Reversal after block",
    afterGuardN: "After {n} blocks",
    afterHit: "Reversal after hit",
    playback: { random: "Random playback of slots", sequential: "Sequential playback" },
    noSlot: "None",
    linked: "Setups",
  },
...
const ja: Dictionary = {
  ...
  setup: {
    ...
    situation: "状況",
    guard: "ガード",
    guardValues: { all: "全てガード", none: "ガードしない", after_first: "1ヒット目以降ガード", random: "ランダムガード" },
    wakeup: "起き上がりリバーサル",
    afterGuard: "ガード後リバーサル",
    afterGuardN: "{n}回ガード後",
    afterHit: "被弾後リバーサル",
    playback: { random: "スロットをランダム再生", sequential: "順番に再生" },
    noSlot: "なし",
    linked: "セットプレイ",
  },
