...
const ko = {
  ...
  setup: {
    ...
    driveReversal: "드라이브 리버설",
    driveReversalValues: { off: "실행하지 않음", guard: "가드 발동", wakeup: "일어서기 발동", random: "랜덤" },
    wakeup: "다운 리버설",
...
const en: Dictionary = {
  ...
  setup: {
    ...
    driveReversal: "Drive Reversal",
    driveReversalValues: { off: "Off", guard: "On block", wakeup: "On wake-up", random: "Random" },
...
const ja: Dictionary = {
  ...
  setup: {
    ...
    driveReversal: "ドライブリバーサル",
    driveReversalValues: { off: "しない", guard: "ガード時", wakeup: "起き上がり時", random: "ランダム" },
    wakeup: "ダウンリバーサル",
