...
export const sampleCombos: Combo[] = [
  {
    ...
    notation_classic: "2LP → 2LP → 5LP → 214LP",
    notation_modern: "2L → 2L → 5L → 214L",
    hit_states: ["normal"],
  ...
  },
  {
    ...
    notation_classic: "DI → (벽꽝) → air HP → delay 5HP → 623KK → 236236P",
    notation_modern: "DI → (벽꽝) → air H → delay 5H → 623SP → 236236H",
    hit_states: ["impact"],
